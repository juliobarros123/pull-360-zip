...
<body>
    ...
    <script>
        function gostei(id_video) {
            var url = window.location.origin + '/reacoes_video/' + id_video + '/gostei';
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: url,
                ...
                data: '',
                success: function(response) {
                    $("#count-gosto-" + id_video).text(response['ttl_gosto']);
                    $("#count-n-gosto-" + id_video).text(response['ttl_nao_gosto']);

                }
            });
        }

        function n_gostei(id_video) {
            var url = window.location.origin + '/reacoes_video/' + id_video + '/nao_gostei';
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: url,
    ...
    @include('layouts._includes.admin.footer2')
</body>
