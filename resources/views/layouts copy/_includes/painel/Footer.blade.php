                 ...
                 var  id_video=gosto['1']; 
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                    ...
                                    document.getElementById("n_gostei_"+id_video).innerHTML = response['ttl_gosto'];
                                    document.getElementById("n_nao_gostei_"+id_video).innerHTML = response['ttl_nao_gosto'];
                            }
                        });
