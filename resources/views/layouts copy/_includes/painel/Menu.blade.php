        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <div class="card-title h4 text-center">Tempo limite para terminar sessão {{$tempoSessao->tempo_termino}}</div>
                    <div class="card-text h5 text-center">Tempo em andamento:<span
                            class=" rounded cor-branco-detalhe   cor-branco-detalhe  " id="counter">
                            00:00:00</span></div>
                            <div class="card-title h6 text-warning text-center">Clica no botão abaixo para reiniciar a contagem
                ...
                @if (Auth::User()->vc_tipoUtilizador == 'Administrador' || Auth::User()->vc_tipoUtilizador=='Desenvolvedor' || Auth::User()->vc_tipoUtilizador == 'Encarregado')
                    ...
                    <li class="nav-item dropdown">
                        <a href="#forms" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                            <i class="fe fe-credit-card fe-16"></i>
                            <span class="ml-3 item-text">Matrículas</span>
                        </a>
