                ...
                @isset($materiaVideo['0'])
                    ...
                    <section data-simplebar="init" style="height:420px; overflow-y: auto; overflow-x: hidden;">
                        ...
                        <div  class="row lightGallery ">
                            ...
                            <div 
                                class=" shadow p-2  col-md-4 text-decoration-none" data-abc="true">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a class="dropdown-item small" href="{{ route('materia.excluirVideo', $video->id) }}"
                    ...
                    <div class=" table-responsive">
                        <table class="table table-sm mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td scope="row">
                                        <div class="d-inline-block">  <a href="{!! url('storage/' . $PDF->vc_pdf) !!}" target="_blank">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                href="{{ route('materia.editarPDF', ['id_materia' => $materia->id, 'id_PDF' => $PDF->id]) }}"><i
                                                    class="fe fe-edit-3 fe-12 mr-4"></i>Editar</a>
                                            <a class="dropdown-item small" href="{{ route('materia.excluirPDF', $PDF->id) }}"
                                                data-confirm="Tem certeza que deseja eliminar?"><i
                                                    class="fe fe-delete fe-12 mr-4"></i>Eliminar</a>
