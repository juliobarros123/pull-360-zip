                ...
                @foreach ($materias as $materia)
                    ...
                    <div class="card-body">
                                ...
                                <div class="row w-100">
                                    @foreach ($materiaVideo as $video)
                                        <div class="d-flex flex-column col-md-4 mt-3 ">
                                            ...
                                            <h1 class="titulo-video cor-texto-dinamico">{{ $materiaVideo['0']->id_materia }}.ª
                                                ...
                                                <div class="card-custom rounded p-3">
                                                    <div class="d-flex">
                                                        <div class="rounded p-2 mr-2 d-flex align-items-center justify-content-center download-container"
                                                            ...
                                                            <a href="{{ url("storage/{$video->vc_video}") }}" download>
                                                                <i class="fas fa-cloud-download-alt texto-verde"></i>
                                                            </a>
                                                        </div>
                                                        <div>
                                                            <div class="titulo-download">As vogais e o Alfabeto</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="w-100 mb-4">
                            <div class="mb-4 cor-texto-dinamico">Arquivos
                                sobre Aulas</div>
                                    ...
                                    <table class="table table-sm mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <td scope="col">
                                                    <div class="d-inline-block"><strong>Acções</strong></div>
                                                </td>
                                                @if (Auth::User()->vc_tipoUtilizador == 'Administrador' || Auth::User()->vc_tipoUtilizador == 'Gestor_conteudo' || Auth::User()->vc_tipoUtilizador == 'Desenvolvedor')
                                                    <td scope="col">
                                                        <div class="d-inline-block"><strong>Acções</strong></div>
                                                ...
                                                @if ($PDF->id_materia == $materia->id)
                                                    <tr>
                                                        ...
                                                        <td scope="row">
                                                            <div class="d-inline-block"> <a href="{!! url('storage/' . $PDF->vc_pdf) !!}"
                                                                    target="_blank"
                                                                    class="btn btn-secondary-reverse rounded-pill btn-sm px-2">
                                                                    Ver
                                                                </a></div>
                                                        </td>
                                                        @if (Auth::User()->vc_tipoUtilizador == 'Administrador' || Auth::User()->vc_tipoUtilizador == 'Gestor_conteudo' || Auth::User()->vc_tipoUtilizador == 'Desenvolvedor')
                                                    ...
                                                    <tr>
                                                        <td scope="row">
                                                            <div class="d-inline-block"> <audio controls="controls">
                                                                    <source src="{!! url('storage/' . $audio->vc_audio) !!}"
                                                                        type="audio/mp3" />
                                                        ...
                                                        <td scope="row">
                                                            <div class="d-inline-block"> <a href="{!! url('storage/' . $audio->vc_audio) !!}"
                                                                    target="_blank">
                                                                    <p class="mb-0 text-dark">{{ $audio->vc_descricao }}
                                                                    </p>
                                                                </a></div>
                                                        </td>
