                ...
                <div class="col-md-12 col-lg-12 col-xl-12 mb-4">
                    <div class="bg-white shadow p-4 h-100">
                        ...
                        <h4 class="text-secondary text-center">
                            Os seus dados são protegidos pela lei da protecção dos dados pessoais (Lei N.* 22/11, de 17 de Junho).</h4>


                        <form action="{{ route('professor.cadastrarProfessor') }}" method="post" enctype="multipart/form-data"
                            class="">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input required type="text" name="vc_BI" minlength="14"
                                        class="form-control bg-white rounded-pill " aria-describedby="emailHelp"
                                        placeholder="BI/NIF"
                                        style="border-radius: 46px!important;" maxlength="14">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input required type="number" name="it_num_agente" 
                                        ...
                                        style="border-radius: 46px!important;"  required>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group  col-md-4">
                                    <div class="form-group">
                                        <label class="bold" for="theme">{{ __('Seleccione a docência *') }}</label>
                                        <select class="form-control bg-white rounded-pill" name="docencia" id="id_tipo_professor" required>
                                ...
                                <div class="form-group  col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control bg-white rounded-pill" name="id_classe" id="id_classe" required>
...
$.ajax({
        ...
        success: function(response) {
            ...
            $.each(response, function(id, name) {
                    $("#modal-body-disciplinas").append(' <div class="form-group ">  <p >' + name +'</p> <input  type="checkbox"  name='+ id +'  > </div>');
                });
